...
exports.removeNodesOutsideFrameBounds = void 0;
const __1 = require("../..");
function removeNodesOutsideFrameBounds(startNode) {
    // only do this for top-level frames
    const nodes = __1.FigmaCalculator.FindChildren(startNode, (n) => n.type === "FRAME");
    for (let i = 0; i < nodes.length; i++) {
        ...
        for (let k = 0; k < oobNodes.length; k++) {
            try {
                __1.FigmaCalculator.RemoveNode(startNode, oobNodes[k].id);
            }
            catch (e) {
...
exports.removeNodesOutsideFrameBounds = removeNodesOutsideFrameBounds;
