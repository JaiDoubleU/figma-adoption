...
function isExactStyleMatchFromCloud(styleType, styleBucket, targetNode) {
    ...
    // check corresponding Id props to verify exact matches
    if (styleType === "FILL") {
        styleKey = targetNode.styles["fill"];
    }
